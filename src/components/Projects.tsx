            ...
            <div className="container mx-auto max-w-7xl relative z-10">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
                        A curated selection of platforms I have built — covering mobile apps,
                        management systems, service platforms, and event solutions.
                    </p>
                </motion.div>
                    ...
                    {projects.map((project, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <Card className="p-6 bg-card border border-border/30 rounded-xl hover:shadow-lg transition-all h-full flex flex-col justify-between bg-white/5 ">
